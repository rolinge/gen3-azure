...
resource "azurerm_application_gateway" "network" {
  ...
  lifecycle {
    ignore_changes = [tags, backend_http_settings, request_routing_rule, probe, http_listener, frontend_port, backend_address_pool, ssl_certificate, url_path_map, redirect_configuration]
  }
